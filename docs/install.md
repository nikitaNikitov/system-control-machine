...
Если сервак больше не тестируется и установлен на продакшн, то необходимо DEBUG установить на 'False' и добавить доступные хосты в файле 'main_site/settings.py'
